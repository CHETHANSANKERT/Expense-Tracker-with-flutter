...
class _NewExpenseState extends State<NewExpense> {
    ...
    if (Platform.isIOS) {
      showCupertinoDialog(
        ...
        builder: (ctx) => CupertinoAlertDialog(
          ...
          content: const Text(
              "Please review your input and make any necessary corrections before proceeding further."),
          actions: [
            TextButton(
              onPressed: () {
                Navigator.pop(ctx);
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (ctx, constraints) {
      final wdth = constraints.minWidth;
              ...
              children: [
                if (wdth >= 600)
                  ...
                  TextField(
                    ...
                    // keyboardType: TextInputType.emailAddress,   //This is used to set different keyboaard pattern
                  ),
                if (wdth >= 600)
                  Row(
                    children: [
